...
const View = React.createClass({
  ...
  propTypes: {
    ...
    * synthetic touch event as described above.
     ...
     *
     */
    cursorVisibilitySlop: PropTypes.oneOfType([
      PropTypes.number,
      EdgeInsetsPropType,
    ]),
    ...
    onGazeEnter: PropTypes.func,
    onGazeExit: PropTypes.func,
    onMouseEnter: PropTypes.func,
    onMouseExit: PropTypes.func,
    onChange: PropTypes.func,
    onInput: PropTypes.func,
    onHeadPose: PropTypes.func,
    onGazeInput: PropTypes.func,
    onGazeHeadPose: PropTypes.func,
    onMouseInput: PropTypes.func,
    onMouseHeadPose: PropTypes.func,
    onChangeCaptured: PropTypes.func,
    onInputCaptured: PropTypes.func,
    onHeadPoseCaptured: PropTypes.func,
    onGazeInputCaptured: PropTypes.func,
    onGazeHeadPoseCaptured: PropTypes.func,
    onMouseInputCaptured: PropTypes.func,
    onMouseHeadPoseCaptured: PropTypes.func,
    /**
    ...
    /**
     * Allows the control of gaze collision for this view and all child views, when not enabled no
     * collision checks will be performed within the system. It would be as if that view was not there
     *
     * @platform vr
     */
    enableGazeCollision: PropTypes.bool,
  },
