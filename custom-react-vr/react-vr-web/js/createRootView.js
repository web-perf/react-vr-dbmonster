...
/**
 * Contains the majority of the boilerplate work needed to set up
 */
...
export default function createRootView(guisys, name, options = {}) {
  if (!guisys) {
